...
module.exports = class walletNode extends EventEmitter {
  constructor (nodeAddress, readyCallback) {
    ...
    const packageDefinition = protoLoader.loadSync(__dirname + '/../protos/sedrawalletd.proto', {
      keepCase: true,
      longs: String,
      enums: String,
      defaults: true,
      oneofs: true
		...
		const { sedrawalletd } = gRPC.loadPackageDefinition(packageDefinition).sedrawalletd

    this._client = new sedrawalletd(nodeAddress, gRPC.credentials.createInsecure(), {  
